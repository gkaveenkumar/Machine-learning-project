...
# Get the working directory of this script (works on any machine / Streamlit Cloud)
...
if selected == 'Diabetes Prediction':
    ...
    if st.button('Diabetes Test Result'):
        try:
            ...
            diab_diagnosis = '⚠️ Please fill in all fields with valid numbers.'
...
if selected == 'Heart Disease Prediction':
    ...
    if st.button('Heart Disease Test Result'):
        try:
            ...
            heart_diagnosis = '⚠️ Please fill in all fields with valid numbers.'
...
if selected == "Parkinsons Prediction":
    ...
    if st.button("Parkinson's Test Result"):
        try:
            ...
            parkinsons_diagnosis = '⚠️ Please fill in all fields with valid numbers.'
